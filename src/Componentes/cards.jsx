    ...
    <div className='w-full  h-screen relative flex justify-center items-center overflow-hidden'>
      <div className='w-full  h-screen absolute overflow-hidden bg-opacity-100'>
       <div className='relativ bg-opacity-100'>
        <div className='rounded-full w-[562px] h-[562px] bg-blue-400 left-[500px] bottom-[-432px] absolute'></div>
        <div className='rounded-full w-[605px] h-[605px] bg-red-400 right-[-190px] top-[-346px] absolute opacity-[60%]'></div>

        <div className='rounded-full w-[290px] h-[290px] bg-red-400 left-[-112px] bottom-[-111px] absolute opacity-[60%]'></div>

        <div className='rounded-full w-[428px] h-[428px] bg-yellow-400 right-[-161px] bottom-[-282px] absolute opacity-[60%]'></div>

        <div className='rounded-full w-[562px] h-[562px] bg-blue-400 left-[-151px] top-[-156px] absolute opacity-[60%]'></div></div>
      </div>
