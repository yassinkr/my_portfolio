...
import figma_icon from './svg/figma_icon.svg';
...
const Expertiese = () => {
  return (
    <div className='relative w-full  h-screen flex justify-center items-center overflow-hidden '>
      ...
      <div className='absolute bg-blue-400 right-[-8rem] bottom-[-4rem] w-[30rem] h-[30rem] rounded-full'></div>
      <div className='absolute bg-blue-400 left-[-8rem] bottom-[-4rem] w-[30rem] h-[30rem] rounded-full'></div>

      <div className='absolute bg-blue-500 right-48 bottom-[-12rem] w-96 h-96 rounded-full'></div>
      <div className='absolute bg-blue-500 left-48 bottom-[-12rem] w-96 h-96 rounded-full'></div>
